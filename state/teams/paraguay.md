...
Under Gustavo Alfaro (Copa America 2024 onwards): transformed; lost only 1 match, beat Argentina and Brazil in qualifying.
Notable Alfaro-era results:
- Beat Argentina (in CONMEBOL qualifying)
- Beat Brazil 1-0 (qualifying)
- Post-Copa America unbeaten run
...
xGD +0.12 — one of only 4 CONMEBOL teams positive post-Copa America.
...
- **Miguel Almiron** (MID/ATT, Atlanta United or club TBC): veteran creative midfielder; Paraguay captain (with Gomez). Transition-focused, direct runner. Set-piece delivery. Source: Atlanta United/FIFA, May 2026.
- **Gustavo Gomez** (DEF/CB, Palmeiras, captain): 88+ caps; former AC Milan. Physical leader. Set-piece threat at corners. Source: FIFA, Jun 2026.
...
- Coach: Gustavo Alfaro — appointment was turning point after Copa America 2024. Tactical discipline.
...
## Matchup notes
Style: deep defensive block (4-4-2), physical pressing, set-piece heavy, counter-attack via transition (Almiron). Crowd the 6-yard box. Very hard to break down. Best defensive metrics in CONMEBOL post-Alfaro per xGA.
...
Climate: Asuncion averages ~25 degrees C June — squad acclimatised to warm weather. LA/Seattle venues are mild. No heat disadvantage. Travel from South America manageable.
...
Set pieces: Gomez (CB) and Almiron delivery are primary dead-ball threats. Paraguay historically rate set pieces in qualifying.
...
- **Group result**: Finished 2nd in Group D (W0 D1 L2, 1 GF 5 GA). Lost 1-4 to USA, lost 0-1 to Turkey (10-men after Almiron red R2), drew 0-0 with Australia. Qualified as runners-up due to Australia and Turkey also having limited records.
- **Miguel Almiron**: received straight red card vs Turkey (R2, 45+3'). Served that ban in R3 vs Australia. **Almiron IS available for R32**. Source: group-r2 results, 2026-06-28.
